...
Tags: color, colour, image, automatic, dominance, dominant
...
== Description ==
A WordPress plugin to automatically save the dominant color and a color palette for an attachment image into post_meta using the ksubileau/color-thief-php library.

== Installation ==
The dominant color and color palette are automatically saved on upload and edit to post meta.
